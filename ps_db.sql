...
--
-- Host: localhost    Database: printstudy2
-- ------------------------------------------------------
...
CREATE TABLE `documents` (
  `doc_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `doc_name` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `doc_paid` tinyint(1) NOT NULL,
  `print_left` tinyint(10) NOT NULL,
  PRIMARY KEY (`doc_id`)
...
-- Dump completed on 2020-06-08 22:34:54
